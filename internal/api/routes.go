...
func (s *Server) routes() *http.ServeMux {
	...
	mux.Handle("GET /api/providers/{name}/models", requireAuth(http.HandlerFunc(s.handlers.ListProviderModels)))
	mux.Handle("POST /api/providers/{name}/test-connection", requireAuth(http.HandlerFunc(s.handlers.TestProviderConnection)))
	...
	mux.Handle("GET /api/agents/{name}/mcp", requireAuth(http.HandlerFunc(s.handlers.GetAgentMCP)))
	mux.Handle("PUT /api/agents/{name}/mcp", requireAuth(http.HandlerFunc(s.handlers.SetAgentMCP)))
	mux.Handle("PUT /api/agents/{name}/tools", requireAuth(http.HandlerFunc(s.handlers.SetAgentTools)))
	mux.Handle("GET /api/agents/{name}/persona/{file}", requireAuth(http.HandlerFunc(s.handlers.GetAgentPersona)))
	mux.Handle("PUT /api/agents/{name}/persona/{file}", requireAuth(http.HandlerFunc(s.handlers.SetAgentPersona)))

...
| Codex | `model/Codex` | Also supports AWS Bedrock via `ByBedrock: true` |
...
- `reference/model/*.md` -- ChatModel interfaces, tool binding, streaming, and per-provider config (openai, Codex, gemini, ark, ollama, deepseek, qwen, qianfan, openrouter)

...
Enable updating of agent configurations including model, reasoning options, system prompt, and other properties, while ensuring strict validation and proper hot-reloading.
